...
class PROJECTF_API TakeDownState : public ICombatState
{
public:
	virtual ~TakeDownState() override = default;
	...
	static TUniquePtr<TakeDownState> Create() { return MakeUnique<TakeDownState>(); }
};
